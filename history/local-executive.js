(()=>{
  ...
  function drawLocalComparisonMap(target,rows,side){
    ...
    map.attr('viewBox',`0 0 ${w} ${h}`).attr('preserveAspectRatio','xMidYMid meet');const projection=d3.geoMercator().fitExtent([[32,34],[w-32,h-76]],{type:'FeatureCollection',features:pairedCore(features)}),path=d3.geoPath(projection);
