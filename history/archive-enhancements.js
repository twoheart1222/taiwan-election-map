(()=>{
  ...
  function buildCompareUI(){
    const slot=$('#archive-compare-slot'),result=$('#archive-compare-result');if(!slot||!result||slot.firstElementChild)return;
    slot.innerHTML=`<div class="archive-compare-workspace"><div class="archive-compare-top"><label class="archive-year-select"><span>A 年份</span><select id="archive-compare-a" aria-label="比較 A 年份"></select></label><button type="button" id="archive-compare-swap" class="archive-compare-swap" aria-label="交換 A 與 B 年份">⇄</button><label class="archive-year-select"><span>B 年份</span><select id="archive-compare-b" aria-label="比較 B 年份"></select></label><div class="archive-layer-field"><span>地圖圖層</span><div class="archive-segment archive-layer-switch" role="group" aria-label="比較地圖圖層"><button type="button" data-layer="winner" class="on">勝方版圖</button><button type="button" data-layer="share">得票率變化</button><button type="button" data-layer="swing">藍綠 Swing</button></div></div></div></div>`;
    result.innerHTML=`<div class="archive-compare-body"><div class="archive-compare-summary"><div class="archive-compare-heading"><div><div class="archive-compare-kicker">CROSS-ELECTION COMPARISON</div><h3 class="archive-compare-title">跨屆比較</h3></div></div><div class="archive-segment archive-party-switch" id="archive-party-switch" role="group" aria-label="選擇得票率變化政黨"><button type="button" data-party="DPP" class="on">民主進步黨</button><button type="button" data-party="KMT">中國國民黨</button></div><div class="archive-map-legend" id="archive-map-legend"></div><div class="archive-compare-inspector"><div class="archive-compare-note"></div><div class="compare-region-heading"><strong>勝方政黨翻轉縣市</strong><span>僅顯示 A → B 顏色有變化</span></div><div class="archive-flips compare-region-picker" id="archive-flips" aria-label="勝方政黨翻轉縣市"></div></div><div id="archive-compare-chart" class="paired-compare-chart"></div><div class="archive-compare-stats" id="archive-compare-stats"></div><div class="archive-compare-detail" id="archive-compare-detail">點擊地圖查看縣市變化。</div></div></div>`;
