...
if (!html.includes('data-history-town-drilldown')) {
...
`;
  html = html.slice(0, boundary) + insertion + html.slice(boundary);
}
...
console.log('history/index.html township drilldown link is present.');
